...
<div class="game-background" style="--mouse-x: {mouseX}; --mouse-y: {mouseY}">
	<div class="wordsearch-bg-piece piece1"></div>
	<div class="wordsearch-bg-piece piece2"></div>
	<div class="wordsearch-bg-piece piece3"></div>
	<div class="wordsearch-bg-piece piece4"></div>
	<div class="wordsearch-bg-piece piece5"></div>
	<div class="wordsearch-bg-piece piece6"></div>
...
<style>
	...
	.wordsearch-bg-piece {
		position: absolute;
		opacity: 0.1;
		background-image: url("data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill='%2310b981' d='M20 20 L80 20 L80 80 L20 80 Z'/%3E%3C/svg%3E");
